import { StocksTable } from "@/app/ui/components/banks/tables";
...
export default async function Page({
  ...
  return (
    <div>
      <div className="flex flex-row"><PresentationChartLineIcon className="w-6 h-6 stroke-2 mb-3" /><h1 className="text-lg px-2">Bank Stock movements</h1></div>
      <SearchBar placeholder={"Enter query"} defaultLimit={currentLimit} />
      <StocksTable query={query} currentPage={currentPage} limit={currentLimit} df={df} dt={dt}/>
